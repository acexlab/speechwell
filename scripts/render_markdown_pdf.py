...
def build_styles():
    ...
    return {
        "title": ParagraphStyle("TitleCustom", parent=styles["Title"], fontName="Helvetica-Bold", fontSize=20, leading=24, alignment=TA_CENTER, spaceAfter=10),
        "h1": ParagraphStyle("H1", parent=styles["Heading1"], fontName="Helvetica-Bold", fontSize=16, leading=20, spaceBefore=10, spaceAfter=8, textColor=colors.HexColor("#17324D")),
        "h2": ParagraphStyle("H2", parent=styles["Heading2"], fontName="Helvetica-Bold", fontSize=13, leading=16, spaceBefore=8, spaceAfter=6, textColor=colors.HexColor("#244E73")),
        "h3": ParagraphStyle("H3", parent=styles["Heading3"], fontName="Helvetica-Bold", fontSize=11, leading=14, spaceBefore=6, spaceAfter=4, textColor=colors.HexColor("#355F87")),
        "body": ParagraphStyle("Body", parent=styles["BodyText"], fontName="Helvetica", fontSize=10, leading=14, spaceAfter=6),
        "code": ParagraphStyle("Code", parent=styles["Code"], fontName="Courier", fontSize=8.5, leading=11, leftIndent=8, rightIndent=8, backColor=colors.HexColor("#F4F6F8"), borderPadding=6, borderWidth=0.5, borderColor=colors.HexColor("#D6DCE3"), spaceBefore=4, spaceAfter=8),
        "bullet": ParagraphStyle("Bullet", parent=styles["BodyText"], fontName="Helvetica", fontSize=10, leading=14, leftIndent=10, firstLineIndent=0, spaceAfter=2),
    }
...
def flush_list(items: list[str], story: list, styles: dict) -> None:
    ...
    story.append(
        ListFlowable(
            [ListItem(Paragraph(inline_format(item), styles["bullet"])) for item in items],
            bulletType="bullet",
            leftIndent=14,
        )
    )
